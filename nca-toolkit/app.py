...
def create_app():
    ...
    from routes.v1.image.transform.image_to_video import v1_image_transform_video_bp, v1_image_transform_video_2segments_bp
    ...
    app.register_blueprint(v1_image_transform_video_2segments_bp)
